...
import hbec.app.hospital.util.MD5Util;
import hbec.app.hospital.util.TenpayUtil;
...
/*
 ...
 '============================================================================
 '*/
public class PaySignRequestHandler {
	/** Token获取网关地址地址 */
	 ...
	 * 创建md5摘要,规则是:按参数名称a-z排序,遇到空值的参数不参加签名。
	 */
	public String createSignForPay(SortedMap<String, String> packageParams) {
		StringBuffer sb = new StringBuffer();
		Set es = packageParams.entrySet();
		Iterator it = es.iterator();
		while (it.hasNext()) {
...
//		sb.setLength(sb.length() -1);
	...
	protected void createSign() {
		...
		sb.append("key=" + Constants.KEY); // 自己的API密钥
